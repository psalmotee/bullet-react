      ...
      <div>
        ...
        <Menu>
          ...
          <MenuItems
            transition
            anchor="bottom end"
            className="w-35 origin-top-right rounded-md shadow-md border border-white/5 bg-white p-1 text-sm/6 transition duration-100 ease-out [--anchor-gap:--spacing(1)] focus:outline-none data-closed:scale-95 data-closed:opacity-0 border-d-gray-200"
          >
